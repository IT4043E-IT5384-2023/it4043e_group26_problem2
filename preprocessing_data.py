...
# drop missing values in hashtags column in post_data
df_post = df_post.dropna(subset=['hashtags'])
df_post = df_post.withColumn('hashtags', split(df_post['hashtags'], ',')).withColumn('hashtags', explode('hashtags'))
print(df_post.show(5))
...
## Connect to the file in Google Bucket with Spark
user_transform_path = f"gs://it4043e-it5384/it4043e/it4043e_group26_problem2/transformed-data/user_data_cleaned"
post_transform_path = f"gs://it4043e-it5384/it4043e/it4043e_group26_problem2/transformed-data/post_data_cleaned"
